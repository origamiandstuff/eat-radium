...
Class.miscBosses = menu("Misc Bosses", "red", 6)
...
Class.developer.UPGRADES_TIER_0 = ["tanks", "bosses", "spectator", "levels", "teams", /*"eggGenerator", */"testing", "addons", ["etherealBodyUpgrades", "ethereal"]]
    ...
    Class.bosses.UPGRADES_TIER_0 = ["sentries", "elites", "mysticals", "nesters", "rogues", "rammers", "terrestrials", "celestials", "eternals", "miscBosses"]
        ...
        Class.miscBosses.UPGRADES_TIER_0 = ["miscBoss1"]
	    Class.rammers.UPGRADES_TIER_0 = ["bob", "nemesis"]
        Class.terrestrials.UPGRADES_TIER_0 = ["ares", "gersemi", "ezekiel", "eris", "selene", "zeus"]
