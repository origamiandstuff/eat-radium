...
Class.bipod0 = {
    ...
    GUNS: [
       ...
       },
       {
           ...
           PROPERTIES: {
               TYPE: "bullet",
               SHOOT_SETTINGS: combineStats([g.sniper, g.sniper, g.basic, { size: 0.7 }]),
           }
       },
       {
...
Class.bipod30 = {
    ...
    GUNS: [
       ...
       },
       {
           ...
           PROPERTIES: {
               TYPE: "bullet",
               SHOOT_SETTINGS: combineStats([g.sniper, g.sniper, g.basic, { reload: 0.6, speed: 1.3, size: 0.7, recoil: 0, pen: 1.4 }]),
           }
       },
       {
           POSITION: [7, 12.5, 1.05, 14, 0, 0, 0],
...
Class.piston0 = {
    ...
    ON_ALT: (body) => animate(body, "piston", 10, false, 21),
    GUNS: [
        {
            POSITION: [14, 8, 1, 0, 0, 0, 0],
            PROPERTIES: {
...
for ( let i = 1; i < 10; i++ ) {
    let R1 = Math.floor((255 / 10) * i)
    let R = R1.toString(16)
    let B1 = Math.floor((255 / 10) * (10 - i))
    let B = B1.toString(16)
    Class["piston" + i] = {
        PARENT: "genericTank",
        LABEL: "Piston",
        BODY: {
            SPEED: (0.85 + (i * 0.015)) * base.SPEED,
            FOV: (1.4 - (i * 0.04)) * base.FOV
        },
        GUNS: [
            {
                POSITION: [14 - (i * 0.9), 8 + (i * 0.3), 1, 0, 0, 0, 0],
            },
            {
                POSITION: [27 - (i * 0.5), 8, Math.max(1, -1.4 + (i * 0.24)), 8 - (i * 0.8), 0, 0, 0]
            },
            {
                POSITION: [14, 4, 1, 0, 0, 0, 0],
                PROPERTIES: {
...
Class.piston10 = {
    ...
    LABEL: "Piston",
    DANGER: 4,
    ON_ALT: (body) => animate(body, "piston", 10, true, 21),//btw you can use {}
    GUNS: [
        {
...
//TANK BODIES(i gave up on making them work with bodies lmao)
Class.tank = {
    PARENT: "genericTank",
    LABEL: "Tank"
}
...
Class.tankHealAura = addAura(-1, 3)
Class.healAuraTank = {
    PARENT: "genericTank",
    LABEL: "Thermosphere",
    TURRETS: [
...
Class.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "pounder", "desmos", "healer"]
    ...
    Class.trapper.UPGRADES_TIER_2 = ["builder", "triTrapper", "trapGuard"]
        Class.trapper.UPGRADES_TIER_3 = ["barricade", "overtrapper", "staplegun"]
...
Class.tankBodyUpgrades.UPGRADES_TIER_1 = ["auraTank", "smasher"]
    Class.auraTank.UPGRADES_TIER_2 = ["bigAuraTank", "freezeAuraTank", "healAuraTank"]
        Class.bigAuraTank.UPGRADES_TIER_3 = ["triAuraTank", "bigFreezeAuraTank"]
        Class.healAuraTank.UPGRADES_TIER_3 = ["triHealAuraTank"]
...
Class.role_support = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.single, { damage: -2, pen: 2, health: 2 }]),
                TYPE: "healerBullet"
            }
        },
        {
        ...
        {
            POSITION: [5.5, 10, -1.53, 6.5, 0, 0, 0]
        }
    ]
}
